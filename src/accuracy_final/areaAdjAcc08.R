...
## July 2021
img.class = raster('SF2021/aug/augSF.tif')
img.class.nosar = raster('SF2021/augNoSAR/augSFNoSAR.tif')
valid <- st_read('SFval2021/val202108.shp')
...
#print(xresult, file = '../output/accuracy/areaAdj08.txt')
print(xresult, type = 'html', file = '../output/accuracy/areaAdj08.html')
...
#print(xconfmat, file = '../output/accuracy/confmat08.txt')
print(xconfmat, type = 'html',  file = '../output/accuracy/confmat08.html')
print(xconfmat.nosar, type = 'html',  file = '../output/accuracy/confmat08nosar.html')