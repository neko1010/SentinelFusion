...
## June 2021
img.raw = raster('SF2021/juneNoSAR/juneSFNoSAR.tif')
...
print(xresult, file = '../output/accuracy/areaAdj06NoSAR.txt')

## conf mat
xconfmat = xtable(confmat)

print(xconfmat, file = '../output/accuracy/confmat06NoSAR.txt')