...
## September 2021
img.raw = raster('SF2021/sepNoSAR/sepSFNoSAR.tif')
...
print(xresult, file = '../output/accuracy/areaAdj09NoSAR.txt')

## conf mat
xconfmat = xtable(confmat)

print(xconfmat, file = '../output/accuracy/confmat09NoSAR.txt')