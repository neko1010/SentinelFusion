...
## September 2021
img.class = raster('SF2021/sep/sepSF.tif')
img.class.nosar = raster('SF2021/sepNoSAR/sepSFNoSAR.tif')
valid <- st_read('SFval2021/val202109.shp')
...
##empty column for snow class
empty = rep(0, 5)

confmat = cbind(confmat[,1:3], empty, confmat[,4])
confmat.nosar = cbind(confmat.nosar[,1:3], empty, confmat.nosar[,4])
...
#print(xresult, file = '../output/accuracy/areaAdj09.txt')
print(xresult, type = 'html', file = '../output/accuracy/areaAdj09.html')
...
#print(xconfmat, file = '../output/accuracy/confmat09.txt')
print(xconfmat, type = 'html',  file = '../output/accuracy/confmat09.html')
print(xconfmat.nosar, type = 'html',  file = '../output/accuracy/confmat09nosar.html')