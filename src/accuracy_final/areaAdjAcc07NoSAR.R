...
## July 2021
img.raw = raster('SF2021/julyNoSAR/julySFNoSAR.tif')
...
print(xresult, file = '../output/accuracy/areaAdj07NoSAR.txt')

## conf mat
xconfmat = xtable(confmat)

print(xconfmat, file = '../output/accuracy/confmat07NoSAR.txt')