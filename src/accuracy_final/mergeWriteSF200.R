...
## List full paths
imgs07 = list.files('RFtest/200/', pattern = '*.tif', full.names = TRUE)
## create raster objects
ras07 = lapply(imgs07, raster)
## merge them
sf07 = do.call(merge, ras07) 

writeRaster(sf07, filename = 'RFtest/julySF200.tif', format = 'GTiff')
...
## July 2021
img.raw = raster('RFtest/julySF200.tif')
...
print(xresult, file = '../output/accuracy/areaAdj07SF200.txt')

## conf mat
xconfmat = xtable(confmat)

print(xconfmat, file = '../output/accuracy/confmat07SF200.txt')