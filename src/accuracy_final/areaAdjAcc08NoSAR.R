...
## August 2021
img.raw = raster('SF2021/augNoSAR/augSFNoSAR.tif')
...
print(xresult, file = '../output/accuracy/areaAdj08NoSAR.txt')

## conf mat
xconfmat = xtable(confmat)

print(xconfmat, file = '../output/accuracy/confmat08NoSAR.txt')